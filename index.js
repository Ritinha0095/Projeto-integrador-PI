...
app.get('/listaTib', function (req, res) {
    var tib= new TIB();
    tib.listar(con, function (result) {
        res.render('Evento/TIB/listaTIB.ejs', { tib: result });
    });
});

app.get('/formTib', function (req, res) {
    res.sendFile(__dirname + 'Evento/TIB/formTIB.html');
});
...
app.post('/salvarTib', function (req, res) {
    ...
    res.render('Evento/TIB/resultadoTIB.ejs', { param: tib, msg: 'Delegado registrado com sucesso!' });
});
...
app.post('/gerenciarTib', function (req, res) {
    ...
    if (req.body.acao == 'Excluir') {
        tib.setMatricula(req.body.matricula);
        tib.deletar(con);
        res.render('Evento/TIB/resultadoTIB.ejs', { param: tib, msg: 'Delegado excluido do sistema com sucesso!' });
    } else {
        tib.setMatricula(req.body.matricula);
        tib.consultarChave(con, function (result) {
            res.render('Evento/TIB/formTIB.ejs', { tib: result });
        });
    }
});
...
app.post('/atualizarTib', function (req, res) {
    ...
    res.render('Evento/TIB/resultadoTIB.ejs', { param: tib, msg: 'Delegado atualizado com sucesso!!!' });
});